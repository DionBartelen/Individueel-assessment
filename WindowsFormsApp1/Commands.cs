...
namespace WindowsFormsApp1
{
    public class Commands
    {
        ...
        public static dynamic AddObject(string tunnel, int xPos, int yPos, int zPos, int rotY, double sizeX, double sizeY, string nameNode, bool needTerrain, bool needPanel)
        {
            ...
            double[] aPanelSize = new double[2] { sizeX, sizeY };
        ...
        public static dynamic SetClearColor(string tunnel, string uuidPanel)
        {
            dynamic ClearColor = new
            {
            ...
            return Commands.SendTunnel(tunnel, ClearColor);
        }
